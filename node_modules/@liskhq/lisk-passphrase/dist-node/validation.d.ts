...
export declare const getPassphraseValidationErrors: (passphrase: string, wordlists?: ReadonlyArray<string> | undefined, expectedWords?: number) => ReadonlyArray<PassphraseError>;
export {};
