...
import { Claims, Balance } from "../wallet";
...
export declare class RPCClient {
     ...
     */
    getUnspents(addr: string): Promise<Balance>;
    /**
     * Get the unclaimed gas amount for an address
     */
    getUnclaimed(addr: string): Promise<GetUnclaimedResult>;
    /**
     * Get the claimable for an address
     */
    getClaimable(addr: string): Promise<Claims>;
    private parseUnspentsToBalance;
}
